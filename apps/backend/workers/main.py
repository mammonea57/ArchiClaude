...
class Worker:
    ...
    functions = [noop_task, run_extraction, run_feasibility_job, generate_pdf_job, generate_pcmi_dossier, run_programming_job, ingest_jurisprudences_from_json, ingest_recours_from_json]

...
interface SectionViewerProps {
  /** Raw SVG string for a coupe (section) from the API */
  svgContent: string;
}

export function SectionViewer({ svgContent }: SectionViewerProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-slate-100 bg-slate-50 shrink-0">
        <span className="text-xs font-medium text-slate-600 mr-2">Coupe</span>
